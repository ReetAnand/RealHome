          ...
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              ...
              <span class="color-text-a">
                ...
                Advertise Property on RealHome.com <br/>
Want to list your property on RealHome.com? To do so you must be a member of us. Who in Luxury Real Estate, our international network of brokers. For details please fill out an application form.
<br/><br/>
Need a Broker?<br/>
Are you buying or selling a luxury home? We have contacts all over the world, and we would be happy to recommend a real estate professional where you need one.
<br/><br/>
Web Support for Current Members<br/>
Are you a member experiencing issues? Members can visit our online Help Desk to find answers to frequently asked questions about using RealHome.com.
<br/><br/>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-12 section-t8">
            <div class="row">
              <div class="col-md-7">
                <form action="contact-msg.jsp" method="post">
                  <div class="row">
                ...
                <div class="icon-box section-b2">
                  ...
                  <div class="icon-box-content table-cell">
                    ...
                    <div class="icon-box-content">
                      <p class="mb-1">Message Us<br/>
                        Please tell us how we can assist you otherwise.Email.
                        <span class="color-a">contact@example.com</span>
                      </p>
                      <p class="mb-1">Call Us.
                        <span class="color-a">+12 345 6789</span>
                      </p>
                    </div>
                  </div>
                </div>
