...
{
	response.sendRedirect("owner-welcome.jsp");
} %>
    ...
    <div class="intro intro-carousel">
        <div id="carousel" class="owl-carousel owl-theme">
          <div class="carousel-item-a intro-item bg-image" style="background-image: url(img/property-4.jpg)">
                                    ...
                                    <div class="login-form">
                                       ...
                                       <form action="owner_login.jsp" method="post">
                                           ...
                                           <div class="group">
                                               ...
                                               <input type="email" name="email" required pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$">
                                           </div>
                                           <div class="group">
                                          ...
                                          <div >
                                          <a href="owner-registration.html">
