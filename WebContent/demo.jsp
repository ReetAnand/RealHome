...
<%  if(session.getAttribute("email") !=  null)
{
      ...
      <img class="logo-1" src="images/logo.png" >
        ...
        <div class="navbar-collapse collapse justify-content-center" id="navbarDefault">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="contact2.jsp">Contact</a>
            </li>
          </ul>
        </div>
    ...
    <div class="intro intro-carousel">
        <div id="carousel" class="owl-carousel owl-theme">
          <div class="carousel-item-a intro-item bg-image" style="background-image: url(img/house.jpg)">
			...
			<form action="login.jsp" method="post">        
			 <div class="group">                                    
											  <label for="user" class="label">Email*</label>
                                               <input type="text" name="email" id="email" required pattern="^([a-zA-Z0-9_\-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([a-zA-Z0-9\-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$" title="Put @ and .com"
                                               >
                                            ...
                                            <div class="group">
                                               ...
                                               <input type="password" name="password" id="password" required pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Enter Correct password">
                                            </div>
                                          ...
                                          <div>  
                                             <button style="width: 210px; cursor: pointer;  border: solid grey;
                                              color: black; margin: 20px 2px;" onClick="Toadd()" >Login</button>
                                              </div>
                                               <div >
                                          <a href="registration.html">
                                               <label name="t7" > New member? </label>
